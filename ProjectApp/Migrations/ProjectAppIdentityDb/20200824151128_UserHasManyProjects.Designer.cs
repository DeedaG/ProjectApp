...
{
    [DbContext(typeof(ProjectAppIdentityDbContext))]
    [Migration("20200824151128_UserHasManyProjects")]
    partial class UserHasManyProjects
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectApp.Models.ProjectViewModel", b =>
                {
                    b.HasOne("ProjectApp.Models.ApplicationUser", "User")
                        .WithMany("Projects")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
